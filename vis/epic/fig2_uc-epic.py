...
parser.add_argument(
    '--test-dir', default='/proj/vondrick/ruoshi/github/TPC/uc-dpc/log_new/epic-128_r18_dpc-rnn_bs64_lr0.001_seq8_pred3_len5_ds6_train-all_loss-function-CE_distance-L2_distance-type_uncertain_positive_vs_negative_same_radius-type-log_radius-which-pred', type=str)
...
def get_model(feature_type='F'):
    ...
    model_filename = "epoch480.pth.tar"
...
def main():
    ...
    data_loader_pred = get_data(transform, 'train', num_seq=args.num_seq)
