#!/usr/bin/env python3
# https://raw.githubusercontent.com/theRealSuperMario/supermariopy/master/scripts/tflogs2pandas.py
...
@click.option(
    "--write-pkl/--no-write-pkl",
    help="save to pickle file or not",
    default=False
)
@click.option(
    "--write-csv/--no-write-csv",
    elp="save to csv file or not",
    default=True
)
...
@click.option("--out-file",
              "-of",
              help="output file",
              default="all_training_logs_in_one_file")
def main(logdir_or_logfile: str,
         write_pkl: bool,
         write_csv: bool,
         out_dir: str,
         out_file: str):
